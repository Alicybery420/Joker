...
def meta_bnr():
    ...
    sleep(.1)
    print(color("+G@     Ali Cybery  R@+"))
    sleep(.1)
    print(color("+C@  _  Fuck the system R@+"))
    sleep(.1)
    print(color("+B@ | |_ Rule the world R@+"))
    sleep(.1)
    print(color("+R@  You only live ones R@+"))
    sleep(.1)
    print(color("+W@                                 |_|                   R@+  "))
    sleep(.1)
    print(color("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++"))
...
def tool_bnr():
    ...
    sleep(.1)
    print(color(" +Y@     Ali Cybery  W@+"))
    sleep(.1)
    print(color(" +C@  _  Fuck the System W@+"))
    sleep(.1)
    print(color(" +B@ Rule the world W@+"))
    sleep(.1)
    print(color(" +R@  You only live once W@+"))
    sleep(.1)
    print(color(" +++++++++++++++++++++++++++++++++++++++++++++++++++++++"))
    print(" ")
...
def linux_bnr():
    ...
    sleep(.1)
    print(color("       +R@ Ali Cybery  C@+"))
    sleep(.1)
    print(color("       +G@   Fuck the System C@+"))
    sleep(.1)
    print(color("       +Y@   Rule the world C@+"))
    sleep(.1)
    print(color("              You only live once C@+"))
    sleep(.1)
    print(color("       +++++++++++++++++++++++++++++++++++++"))
    print(" ")
...
def hash_bnr():
    ...
    sleep(.1)
    print(color("+Y@ Ali Cybery  G@+"))
    sleep(.1)
    print(color("+B@ Fuck the System G@+"))
    sleep(.1)
    print(color("+C@ Rule the world G@+"))
    sleep(.1)
    print(color("+W@ You only live once G@+"))
    sleep(.1)
    print(color("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"))
    print(" ")
...
def sites_bnr():
    ...
    sleep(.1)
    print(color("  +    C@ __      Ali Cybery     Y@+"))
    sleep(.1)
    print(color("  +    B@ Fuck the System Y@ +"))
    sleep(.1)
    print(color("  +    R@  Rule the world Y@ +"))
    sleep(.1)
    print(color("  +    W@   Loy Drestize Ali Cybery  Y@ +"))
    sleep(.1)    
    print("  ++++++++++++++++++++++++++++++++++++++++++++++++++")
    print(" ")
...
system("chmod +x Ali CyberyTools-V1.3.py")
system('clear')
alicybery_banner()
...
if OS==1 or OS==2:
	...
	for r in range(0,4):
		...
		print(color(" R@{Y@!R@}Y@ Oops Err .. Please try again .. C@X"),end="\r")
	sleep(2)
	system("python3 Ali CyberyTools-V1.3.py")
